...
generoFavorito varchar(50) not null
);

-- inserir dados na tabela
INSERT INTO usuario(nome, sobrenome, email, telefone, senha, generoFavorito) VALUES
('Beatriz', 'Silva', 'bia22102001@gmail.com', '11976543219', 'Bia123', 'Romance');
...
-- inserir dados na tabela
insert into livro(titulo, autor, editora, data_publicacao, genero, descricao, url_capa, disponivel) values
...
select count(*)  as 'Quantidades de tentaivas' from pontuacao_quiz where fk_usuario;
